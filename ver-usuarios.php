					...
					<div class="page-body">
						<div class="card">
							<div class="card-header">
								<h5>Usuários do hotel</h5>
								<span>Confira os usuários registrados em seu hotel</span>
								<?php
											...
											<div class="col-xs-12 col-sm-12">
												<table id="autofill" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="autofill_info">
													...
													<tbody>
														...
														$users = $PDO2->prepare("SELECT id,username,look,mail,account_created,last_online FROM users ORDER BY id");
														$users->execute();
														while($user = $users->fetch()){ 
															...
															<td><a href="editar-usuario/'.$user['id'].'"><img draggable="false" src="https://i.imgur.com/xsKtItS.gif"></a></td>
															</tr>
															';
														}
														?>
