					...
					<div class="page-body">
						<div class="card">
							<div class="card-block">
								<div class="m-b-20">
									<h4 class="sub-title">Hospedar Ícone</h4>
									<?php
								
	if(!permissao("hospicone")){
		...
		### Informações da API
		$linkapi = $linkswf_api."/c_images/catalogue/upload.php"; /// Link da API
	...
	<form method="post" enctype="multipart/form-data">
		<div class="row">
			<div class="row" style="margin-left: 10px;">
				<label class="col-sm-4 col-lg-5 col-form-label">Ícone</label>									
