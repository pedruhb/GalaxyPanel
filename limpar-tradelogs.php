									...
									<div class="tab-pane active" role="tabpanel">
										<div class="card">
											<div class="card-header">
												<h5 class="card-header-text">Limpar tradelogs</h5>
												<span>Ao clicar no botão abaixo, os tradelogs serão limpos.</span>
											</div>
												...
												<div>
													...
													if(!permissao("limpeza")){
														...
														if (isset($_POST['reinstalar']))
														{
															...
															$selecionatabelas = $PDO2->prepare("TRUNCATE `logs_client_trade`;");
															$selecionatabelas->execute();
															echo '<div class="alert alert-success background-success">
															<strong>Sucesso!</strong> Tradelogs limpos
															</div>';
															addlog('Limpou os tradelogs');
														}
														?>
