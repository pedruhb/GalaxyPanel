									...
									<div class="tab-pane active" role="tabpanel">
										<div class="card">
											<div class="card-header">
												<h5 class="card-header-text">Limpar gráfico</h5>
												<span>Ao clicar no botão abaixo, seu gráfico de usuários onlines será resetado.</span>
											</div>
												...
												<div>
													...
													if(!permissao("limpeza")){
														...
														if (isset($_POST['reinstalar']))
														{
															...
															$selecionatabelas = $PDO2->prepare("TRUNCATE graficos_galayservers;");
															$selecionatabelas->execute();
															echo '<div class="alert alert-success background-success">
															<strong>Sucesso!</strong> Gráfico resetado.
															</div>';
															addlog('Limpou o gráfico.');
														}
														?>
