									...
									<div class="tab-pane active" role="tabpanel">
										<div class="card">
											<div class="card-header">
												<h5 class="card-header-text">Limpar chatlogs</h5>
												<span>Ao clicar no botão abaixo, o chatlog será limpo.</span>
											</div>
												...
												<div>
													...
													if(!permissao("limpeza")){
														...
														if (isset($_POST['reinstalar']))
														{
															...
															$selecionatabelas = $PDO2->prepare("TRUNCATE `chatlogs`;");
															$selecionatabelas->execute();
															echo '<div class="alert alert-success background-success">
															<strong>Sucesso!</strong> Chatlogs limpos
															</div>';
															addlog('Limpou os chatlogs');
														}
														?>
