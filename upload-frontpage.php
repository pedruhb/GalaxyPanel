...
if(!empty($_SESSION['nomeusuario'])){
	...
	<div class="pcoded-content">
					...
					<div class="page-body">
						<div class="card">
							<div class="card-block">
								<div class="m-b-20">
									<h4 class="sub-title">Hospedar imagem</h4>
									<?php
		...
		### Informações da API
		$linkapi = "http://swf.galaxyservers.com.br/c_images/catalogue/frontpage/upload.php"; /// Link da API
		...
		$postfields = array("arquivo" => $cfile, "nome" => $filename);
		$ch = curl_init();
		$options = array(
			CURLOPT_URL => $linkapi,
		...
		<strong>Successo!</strong> o id é: '.$saida.'
		</div>';
		curl_close($ch);
	}
	?> 
	<form method="post" enctype="multipart/form-data">
		<div class="row">
			<div class="row" style="margin-left: 10px;">
				<label class="col-sm-4 col-lg-5 col-form-label">Imagem em .png</label>									
