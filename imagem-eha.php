...
if(!empty($_SESSION['nomeusuario'])){
	...
	<div class="pcoded-content">
					...
					<div class="page-body">
						<div class="card">
							<div class="card-block">
								<div class="m-b-20">
									<h4 class="sub-title">Altere a imagem do event alert.</h4>
									<?php
									if(isset($_POST['hospedar-imagem'])){
		### Informações da API
		$linkapi = $linkswf_api."/c_images/notifications/upload.php"; /// Link da API
		...
		$postfields = array("arquivo" => $cfile, "nome" => $filename, "phblindo" => $server['nomehotel']);
		$ch = curl_init();
		$options = array(
			CURLOPT_URL => $linkapi,
		...
		$saida = curl_exec($ch);
		echo '<div class="alert alert-primary background-primary">
		'.$saida.'
		</div>';
		curl_close($ch);
	}
	?> 
	Clique <a href="https://imgur.com/a/EI96h66" target="_blank">aqui</a> para ver as imagens originais.<br><br>
	<form method="post" enctype="multipart/form-data">
		...
		<br><br>
		<center><button type="submit" style="border-radius: 8px;" name="hospedar-imagem" class="btn btn-primary m-b-0">Hospedar</button></center>
	</form>
</div>
</div>
</div>
