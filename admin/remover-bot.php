		...
		<div class="pcoded-inner-content">
			<div class="main-body">
				<div class="page-wrapper">
                   ...
                   $pastad = "../galaxyservers/emuladores/".$hotel['uservestacp']."/bot_discord/"; //pasta do bot                   
                  ...
                  popen("C:/xampp/htdocs/galaxyservers/emuladores/".$hotel['uservestacp']."/bot_discord/desligar.bat", "r");
                  sleep(5);
                  delTree($pastad);

                  loginsucess("Bot removido do hotel \"".$hotel['uservestacp']."\"!");

                  addlog_admin($_SESSION['useradmin'], "Removeu o bot para discord do hotel \"".$hotel['uservestacp']."\".");

                  $attStatus = $PDO->prepare("UPDATE servidores SET botdiscord = 'desativado' WHERE id = '".$hotel['id']."';");
                  $attStatus->execute();
                  ...
                  <div class="form-group row">
                   ...
                   <div class="col-sm-10">										
                    <select class="form-control" name="hotel_id">
                     <?php
                     $pegadados = $PDO->prepare("SELECT * FROM servidores WHERE ativo = 'Y' and botdiscord not like 'desativado';");
                     $pegadados->execute();
              ...
              <center><button name="ativa" type="submit" class="btn btn-primary btn-square">Desativar</button></center>
            </form>
          </div>
        </div>
      </div>
