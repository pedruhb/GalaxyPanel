						...
						<div class="">
							<div class="card">
								<div class="card-header">
									<h5>Ativar Habbo.swf Própria</h5>
									<span></span>									
...
if ( @ftp_put( $con_id, "./"."'.$hotel['uservestacp'].'".".swf", "C:\/xampp\htdocs\galaxyservers\CompilaHabboSwf\Habbo.swf", FTP_BINARY)) 
{
...
fclose($fp);
											...
											$DbSWF = $PDO->prepare("UPDATE servidores SET habboswf = 'Y' WHERE id = :id");
											$DbSWF->bindParam(':id', $_POST['hotel_id']);
											$DbSWF->execute();

											loginsucess("SWF está sendo compilada, a CMS deve ser configurada para a câmera funcionar.");

											addlog_admin($_SESSION['useradmin'], "Ativou SWF própria do hotel \"".$hotel['uservestacp']."\".");
										}
									}
									?>						
									<form method="POST">
										<div class="form-group row">
											...
											<div class="col-sm-10">										
												<select class="form-control" name="hotel_id">
													<?php
													$pegadados = $PDO->prepare("SELECT * FROM servidores WHERE habboswf = 'N' and ativo = 'Y';");
													$pegadados->execute();
