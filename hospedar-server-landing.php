...
if(!empty($_SESSION['nomeusuario'])){
	...
	<div class="pcoded-content">
					...
					<div class="page-body">
						<div class="card">
							<div class="card-block">
								<div class="m-b-20">
									<h4 class="sub-title">Hospedar imagem landing</h4>
									<?php
									if(!permissao("hosplanding")){
		...
		### Informações da API
		$linkapi = $linkswf_api."/c_images/sl/upload.php"; /// Link da API
		...
		$postfields = array("arquivo" => $cfile, "nome" => $filename, "userpainel"=> $server['uservestacp']);
		$ch = curl_init();
		$options = array(
			CURLOPT_URL => $linkapi,
		...
		$saida = curl_exec($ch);
		$saida = str_replace("%linkswf%", $linkswf_api, $saida);
