...
* MIT licensed
*
* Copyright (C) 2012 Hakim El Hattab, http://hakim.se*/(function(){"use strict";var LIVE_INTERVAL=500;var IS_TOUCH_DEVICE=!!('ontouchstart'in window);var lists=[];var active=false;function refresh(){if(active){requestAnimFrame(refresh);for(var i=0,len=lists.length;i<len;i++){lists[i].update();}}}
