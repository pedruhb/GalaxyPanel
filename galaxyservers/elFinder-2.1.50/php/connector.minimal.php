...
// https://github.com/Studio-42/elFinder/wiki/Connector-configuration-options
	...
	if(!isset($_SESSION['elfinder-host']))
		die("Erro, acesse pelo GalaxyPanel novamente.");
	...
	// 'debug' => true,
		...
		// Items volume
			array(
				'driver' => 'FTP',
				'host'   => $_SESSION['elfinder-host'],
				'user'   => $_SESSION['elfinder-user'],
				'pass'   => $_SESSION['elfinder-pass'],
				'path'   => $_SESSION['elfinder-path']
			)
		)
	);
