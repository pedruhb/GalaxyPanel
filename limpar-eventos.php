									...
									<div class="tab-pane active" role="tabpanel">
										<div class="card">
											<div class="card-header">
												<h5 class="card-header-text">Limpar eventos</h5>
												<span>Ao clicar no botão abaixo, todos os usuários irão para o nível 0.</span>
											</div>
												...
												<div>
													...
													if(!permissao("limpeza")){
														...
														if (isset($_POST['reinstalar']))
														{
															...
															$selecionatabelas = $PDO2->prepare("UPDATE `users` SET `ScoreGame`='0', `Premiar`='0';");
															$selecionatabelas->execute();
															echo '<div class="alert alert-success background-success">
															<strong>Sucesso!</strong> Eventos limpos
															</div>';
															addlog('Limpou os eventos de usuários.');
														}
														?>
